...
class DecoderBlock(nn.Module):
    def __init__(self, self_attention_block: MultiHeadAttention, cross_attention_block: MultiHeadAttention, feedforward_block: FeedForwardBlock, dropout: float):
        ...
        self.residual_connections = nn.ModuleList([ResidualConnection(dropout) for _ in range(3)]) ##!! very important try to understand why like this and not with a moduleList 
